...
class AffineRegularizationLoss(nn.Module):
    ...
    def __init__(self, kz):
        ...
        from dior.models.networks.block_extractor.block_extractor   import BlockExtractor
        from dior.models.networks.local_attn_reshape.local_attn_reshape   import LocalAttnReshape
...
class PerceptualCorrectness(nn.Module):
    ...
    def __init__(self, layer=['rel1_1','relu2_1','relu3_1','relu4_1']):
        ...
        self.layer = layer  
        self.eps=1e-8 
        from dior.models.networks.resample2d_package.resample2d import Resample2d
